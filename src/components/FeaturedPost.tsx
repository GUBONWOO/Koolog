  ...
  return (
    <Link href={`/blog/${post.slug}`} className="group block">
      <article className="relative rounded-3xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
        {/* 배경 그라디언트 */}
        <div
          className={`bg-gradient-to-br ${post.coverColor} p-8 md:p-12 min-h-72 flex flex-col justify-between relative overflow-hidden`}
        >
          {/* 데코 */}
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <span
              className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${post.categoryColor} bg-white/80`}
            >
              {post.category}
            </span>
          </div>
          ...
          <div className="relative z-10 mt-6 md:mt-0 max-w-xl">
            ...
            <div className="mt-5 flex items-center gap-4">
              ...
              <span className="text-xs text-stone-500">{post.readTime} 읽기</span>
