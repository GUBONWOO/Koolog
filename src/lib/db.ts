...
export async function initDB() {
  ...
  await pool.query(`ALTER TABLE posts ADD COLUMN IF NOT EXISTS cover_image TEXT;`);
  await pool.query(`ALTER TABLE posts ALTER COLUMN cover_image TYPE TEXT`).catch(() => {});
  await pool.query(`
